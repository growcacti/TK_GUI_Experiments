...
def create_grid(window):
    ...
    ine1 = canvas.create_line(180, 350, 180, 370 , fill ='black', width = 7)
    ...
    line11 = canvas.create_line(130, 600, 240, 600, fill ='black', width = 7)
...
##
##    line19 = canvas.create_line(180,240, 180,350 , fill ='black', width = 7)
##
##    line20 = canvas.create_line(180, 90, 180, 120, fill ='black', width = 7)
##
##
##
##
